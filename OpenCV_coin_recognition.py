...
img = cv2.imread(r'C:\Users\User\Downloads\Compressed\capstone_coins\19.1 capstone_coins.png', cv2.IMREAD_GRAYSCALE)
original_image = cv2.imread(r'C:\Users\User\Downloads\Compressed\capstone_coins\19.1 capstone_coins.png', 1)
...
for i in circles[0,:]:
    ...
    count_2 += 1
cv2.putText(original_image, 'ESTIMATED TOTAL VALUE: ' + str(sum(values)) + 'p', (200,100), cv2.FONT_HERSHEY_SCRIPT_SIMPLEX, 1.3, 255)
